...
L'analyse étudie les **fonctions** : comment une quantité dépend d'une autre. Dans ce cours (Analyse 1), on travaille avec des **fonctions réelles de variable réelle**, c'est-à-dire des fonctions où $x$ et $y$ sont des nombres réels.
